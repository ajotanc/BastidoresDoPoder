  ...
  <section id="investigacao" class="scroll-mt-24 pt-12 border-t border-line/70">
    ...
    <AppCallout variant="green" title="Versão Digital vs Cartas Físicas:">
      <div class="space-y-2 text-xs sm:text-sm">
        <p>
          <strong class="text-ink">No jogo digital:</strong> a verificação deve ser feita automaticamente e em segredo pelo sistema, revelando apenas o veredito final permitido. O alvo não pode mentir sobre a presença da carta. “Nada encontrado” não abre um novo desafio.
        </p>
        <p class="mb-0">
          <strong class="text-ink">Com cartas físicas na mesa:</strong> recomenda-se um mediador neutro fora da disputa, ou confiança estrita na integridade dos participantes.
        </p>
      </div>
    </AppCallout>

    <p class="text-xs text-ink-muted italic border-l-2 border-line pl-3 py-1">
      O Mandado consulta a mão <strong class="text-ink">após os desafios</strong>. Uma carta perdida durante a contestação já não está na mão do alvo. Uma prova seguida de reposição também pode ter alterado os personagens disponíveis.
    </p>
  </section>
</template>
