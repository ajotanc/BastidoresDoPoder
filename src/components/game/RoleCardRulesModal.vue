...
<template>
  ...
  >
        ...
        <div class="flex items-center gap-3.5 min-w-0">
          ...
          >
            <img
              ...
              :alt="`Símbolo de ${props.card.name}`"
    ...
    <div v-if="props.card" class="space-y-4">
      ...
      <div class="p-3 sm:p-4 rounded-xl bg-surface/90 border border-line backdrop-blur-sm shadow-sm flex items-center gap-3.5 sm:gap-4">
        <!-- Avatar oficial do personagem com moldura refinada (apenas para personagens) -->
        <div
          v-if="hasCharacterAvatar"
        ...
        >
          <img
            :src="characterBgImage"
            :alt="`Retrato oficial de ${props.card.name}`"
      ...
      <div class="space-y-3">
        ...
        >
          <div class="flex items-center gap-2 font-bold mb-1.5 text-gold-light">
            <Swords
              v-if="rule.type === 'action'"
              class="w-4 h-4 flex-shrink-0 text-gold"
              aria-hidden="true"
            />
            <ShieldCheck
              v-else-if="rule.type === 'defense'"
              class="w-4 h-4 flex-shrink-0 text-gold"
              aria-hidden="true"
            />
            <Info
